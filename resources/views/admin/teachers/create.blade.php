...
<div class="card ">
    ...
    <a  class="list-group-item list-group-item-action active" style="color:white;"><h6>Add a teacher</h6></a>
    ...
    <div class="card-body">
        <form action="{{route('add_teacher')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  <label for="tags_id">Selects Tags</label>
                  <select class="form-control" id="tags_id" name="tags_id" multiple>
                   
                        <option value="akr" selected>akromjon</option>
                        <option value="ietls" selected>numonov</option>
