                    ...
                    <a href="{{route('add_course')}}"><button class="btn btn-success float-right mt-2" >add a course</button></a>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="txt-oflo"><img style="width: 50px; height:50px;" src="{{asset('files/courses/')}}/{{$course->slug}}/{{$course->image}}" alt="6.png"></td>                                
                                <td><a style="display: inline-block;" href="{{route('edit_course',$course->id)}}" class="label btn btn-success label-rounded">edit</a>
                                    <form style="display: inline-block;" method="post" action="{{route('delete_course',$course->id)}}">
                                        @csrf
                                        {{ method_field('DELETE') }}
                                ...
                                <td class="txt-oflo">{{$course->confirm}}</td>
