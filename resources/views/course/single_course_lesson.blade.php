                ...
                <div class="row">
                                ...
                                <div class="courses_single_container">
                                    ...
                                    <div class="cs_rwo_tabs csv2">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="course-tab" data-toggle="tab"
                                                    href="#course" role="tab" aria-controls="course"
                                                    aria-selected="false"><i class="fa fa-video-camera"
                                                        aria-hidden="true"></i> Darslar</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " id="Overview-tab" data-toggle="tab"
                                                    href="#Overview" role="tab" aria-controls="Overview"
                                                    aria-selected="true"><i class="fa fa-file-text"
                                                        aria-hidden="true"></i> Kurs </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="instructor-tab" data-toggle="tab"
                                                    href="#instructor" role="tab" aria-controls="instructor"
                                                    aria-selected="false"><i class="fa fa-user-circle"
                                                        aria-hidden="true"></i> O'qituvchi</a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <div class="tab-pane fade show" id="Overview" role="tabpanel"
                                                ...
                                                <div class="cs_row_two csv2">
                                                    <div class="cs_overview">
                                                        ...
                                                        <p class="mb30">Lorem Ipsum is simply dummy text of the printing
                                                        ...
                                                        <p class="mb20">It was popularised in the 1960s with the release
                                                        ...
                                                        <ul class="list_requiremetn">
                                                            <li><i class="fa fa-circle"></i>
                                                                <p>You will need a copy of Adobe XD 2019 or above. A
                                                                    free trial can be downloaded from Adobe.</p>
                                                            </li>
                                                            <li><i class="fa fa-circle"></i>
                                                ...
                                                <div class="cs_row_four csv2">
                                                    <div class="about_ins_container">
                                                        ...
                                                        <div class="about_ins_info">
                                                            <div class="thumb"><img
                                                                    src="{{ asset('assets/images/team/6.png') }}"
                                                                    alt="6.png"></div>
                                                        </div>
                                                        <div class="details">
                                                            <ul class="about_info_list">
                                                                <li class="list-inline-item"><span
                                                                        class="flaticon-comment"></span> 12 Fikrlar
                                                                </li>
                                                                <li class="list-inline-item"><span
                                                                        class="flaticon-profile"></span> 14 O'quvchilar
                                                                </li>
                                                                <li class="list-inline-item"><span
                                                                        class="flaticon-play-button-1"></span> 5 Kurslar
                                                                </li>
                                                            </ul>
                                                        ...
                                                        <div class="mbp_comment_form style2 pb0">
                                                            ...
                                                            <form class="comments_form">
                                                                <div class="form-group">
                                                                    <label for="exampleInputName1">Fikr yoki taklif
                                                                        nomi</label>
                                                                    <input type="text" placeholder="Taklif"
                                                                        class="form-control" id="exampleInputName1"
                                                                        aria-describedby="textHelp">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="exampleFormControlTextarea1">Fikr yoki
                                                                        taklif</label>
                                                                    <textarea class="form-control"
                                                                        id="exampleFormControlTextarea1"
                                                                        rows="6"></textarea>
                                                                </div>
                                                                <button type="submit" class="btn btn-thm">Jo'natish<span
                                                    ...
                                                    <div class="sfeedbacks">
                                                        <div class="mbp_pagination_comments">
                                                            <div class="mbp_first media csv1">
                                                                <img src="{{ asset('assets/images/team/6.png') }}"
                                                                ...
                                                                <div class="media-body">
                                                                    ...
                                                                    <a class="sspd_postdate fz14" href="#">6 months
                                                                        ago</a>
                                                                    <p class="fz15 mt20">This is the second Photoshop
                                                                        course I have completed with Cristian. Worth
                                                                        every penny and recommend it highly. To get the
                                                                        most out of this course, its best to to take the
                                                                        Beginner to Advanced course first.</p>
                                                                    <p class="fz15 mt25 mb25">The sound and video
                                                                        quality is of a good standard. Thank you
                                                                        Cristian.</p>
                    ...
                    <div class="col-lg-4 col-xl-3">
                        <div class="instructor_pricing_widget">
                            <div class="price" style="color: red"><span>Narxi</span> {{ $courses->cost }} so'm <s
                                    style="color: black"><strong><br>69 000</strong> </s></div>
                            <a href="#" class="cart_btnss_white">Sotib olish</a>
                            <h5 class="subtitle text-left">Kurs quyidagilarni o'z ichiga oladi</h5>
                            <ul class="price_quere_list text-left">
                                <li><a href="#"><i class="fa fa-play" aria-hidden="true"></i> {{ $courses->section }}
                                        Darslar</a></li>
                                <li><a href="#"><i class="fa fa-file-video-o" aria-hidden="true"></i>
                                        {{ $courses->videos }} Videolar</a></li>
                                <li><a href="#"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                        {{ $courses->quiz }} Quizlar</a></li>
                                <li><a href="#"><i class="fa fa-language" aria-hidden="true"></i>
                                        {{ $courses->language }}</a></li>
