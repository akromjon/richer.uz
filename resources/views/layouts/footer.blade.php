				...
				<div class="row center">
					<div class="col-sm-6 col-md-4 col-md-3 col-lg-3">
						<div class="footer_contact_widget">
							<h4>Biz bilan aloqa qilish</h4>
							<p>Agar sizda savol, taklif, shikoyat bo'lsa</p>
							<p>Biz bilan bog'laning.</p>
							<p><i class="fa fa-phone" aria-hidden="true"></i> +998 99 000 53 03</p>
							<p class="email"><a class="email" href=""><i class="fa fa-envelope" aria-hidden="true"></i> akyprog@gmail.com</a></p>
							<p class=""><a class="email" href=""><i class="fa fa-telegram" aria-hidden="true"></i> @akrom_numonov</a></p>
						</div>
					</div>
						...
						<div class="footer_apps_widget">
							...
							<div class="app_grid">							
								<button class="play_store_btn btn-dark">
									...
									<span class="subtitle">Ko'chirish</span>
								</button>
							</div>
						</div>
					</div>
